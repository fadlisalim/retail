    ...
    private function allInOne(): array
    {
        return [
            ...
            [
                ...
                'warranty' => 'Garansi 2 Tahun',
                'estimated_processing' => '1-3 hari kerja',
                'short_description' => 'Sistem all-in-one 5kW layar sentuh: inverter 5kW + baterai LiFePO4 5,12 kWh + MPPT 5000W dalam satu unit ber-roda. Bisa bekerja tanpa baterai, ada USB & DC 12V.',
                'description' => $this->html(
                    '<p><strong>JSD Solar JHP5000</strong> menggabungkan <strong>inverter 5 kW</strong>, <strong>baterai LiFePO4 51,2V 100Ah (5,12 kWh)</strong>, dan <strong>solar charger MPPT hingga 5.000 W</strong> dalam satu unit ber-roda dengan <strong>layar sentuh berwarna</strong>. Tinggal colok panel surya — tanpa merakit inverter, baterai, dan kabel satu per satu.</p>',
                    [
                        '📱 <strong>Layar sentuh berwarna</strong> — alur daya PV/PLN/baterai/beban terbaca sekilas, pengaturan tanpa kombinasi tombol.',
                        '🔋 <strong>Baterai LiFePO4 5,12 kWh</strong> (51,2V 100Ah) dalam casing baja <strong>IP65</strong>, efisiensi sel 99%, konektor Anderson 16 mm².',
                        '🔆 <strong>MPPT 5.000 W</strong>, rentang 120–450 VDC (Voc maks 500 VDC), arus pengisian surya hingga 80 A.',
                        '⚡ Efisiensi puncak <strong>97% (PV → beban)</strong>, pure sine wave.',
                        '☀️ <strong>Bisa bekerja tanpa baterai</strong> — siang hari panel surya langsung menyuplai beban.',
                        '🔌 <strong>Dual output AC</strong> + port <strong>USB 5V</strong> + <strong>DC 12V</strong> — HP dan perangkat DC bisa dicas langsung.',
                        '🧳 <strong>Roda + pegangan</strong> — mudah dipindah meski berkapasitas besar.',
                    ],
                ...
                'specifications' => $this->specs([
                    'Merek' => 'JSD Solar',
                    'Model' => 'JHP5000',
                    'Tipe' => 'All-in-one solar system (inverter + MPPT + baterai, layar sentuh)',
                    'Daya Inverter' => '5 kW',
                    'Antarmuka' => 'Layar sentuh berwarna; indikator INV/CHG/FAULT',
                    'Tegangan Baterai' => '48 VDC (float 54 V, proteksi overcharge 63 V)',
                    'Baterai Terpasang' => 'LiFePO4 51,2V 100Ah — 5.120 Wh',
                    'Arus Pengosongan Baterai' => 'Kontinu 100 A, puncak 150 A (BMS memutus di 200 A)',
                    'Arus Pengisian Baterai' => 'Disarankan ≤50 A, maksimum 100 A (tegangan maks 57 V)',
                    'Impedansi Sel' => '10–25 mΩ, efisiensi 99%, self-discharge 3%/bulan',
                    'Casing Baterai' => 'Baja, IP65, konektor Anderson 16 mm²',
                    'Tipe Solar Charger' => 'MPPT',
                    'Daya PV Maks' => '5.000 W',
                    'Rentang MPPT' => '120–450 VDC (Voc maks 500 VDC)',
                    'Arus Pengisian Surya / PLN' => '80 A / 60 A',
                    'Input AC' => '220/230 V, 50/60 Hz',
                    'Output AC' => '220/230 VAC ±5%, 50/60 Hz, pure sine wave',
                    'Efisiensi Puncak' => '97% (PV → inverter); 93% (baterai → inverter)',
                    'Mode Tanpa Baterai' => 'Ya — PV atau PLN langsung menyuplai beban',
                    'Output Tambahan' => 'Dual AC output, USB 5V, DC 12V',
                    'Mobilitas' => 'Roda + pegangan angkat',
                    'Suhu Pengisian/Pengosongan Baterai' => '-15°C s/d +55°C (penyimpanan -5°C s/d +35°C)',
                    'Dimensi Modul Baterai' => '450 × 200 × 250 mm (42 kg)',
                    'Garansi' => '2 tahun',
                    'Berat Unit' => '±60 kg (estimasi — berat total unit tidak dicantumkan pabrikan)',
                ]),
                'keywords' => 'all in one solar, jsd solar, jhp5000, ess, 5kw, 5kwh, layar sentuh, touchscreen, lifepo4, mppt 5000w, energy storage',
            ...
            [
                ...
                'warranty' => 'Garansi 2 Tahun',
                'estimated_processing' => '1-3 hari kerja',
                'short_description' => 'Sistem all-in-one 6,5kW terbesar di serinya: inverter 6.500W + baterai LiFePO4 6,14 kWh + MPPT 9000W (efisiensi 99,5%) dalam satu unit 53,5 kg.',
                'description' => $this->html(
                    '<p><strong>JSD Solar XHP65K60</strong> adalah all-in-one solar system terbesar di serinya: <strong>inverter 6.500 W</strong>, <strong>baterai 51,2V / 6.144 Wh</strong>, dan <strong>MPPT berkapasitas 9.000 W</strong> dalam satu unit ber-roda. Rasio panel-per-inverter yang lega membuat baterainya tetap cepat penuh meski cuaca berawan.</p>',
                    [
                        '⚡ <strong>Inverter 6.500 W / 230 VAC</strong>, input AC hingga 9.000 W untuk pengisian cepat dari PLN atau genset.',
                        '🔋 <strong>Baterai 51,2V — 6.144 Wh</strong> terpasang di dalam unit.',
                        '🔆 <strong>MPPT 9.000 W</strong>, rentang kerja 60–450 VDC (input 60–500 VDC), arus pengisian 0–120 A, efisiensi pelacakan hingga <strong>99,5%</strong>.',
                        '🌬️ <strong>Pendinginan pintar</strong> (smart fan), rentang operasi -20°C s/d +50°C.',
                        '🧳 <strong>Roda + pegangan</strong> — 53,5 kg tapi tetap mudah dipindah.',
                        '📦 Satu unit menggantikan inverter + baterai + SCC + kabel DC yang dirakit terpisah.',
                    ],
                ...
                'specifications' => $this->specs([
                    ...
                    'Model' => 'XHP65K60',
                    'Tipe' => 'All-in-one solar system (inverter + MPPT + baterai)',
                    'Tegangan Baterai' => '51,2 VDC',
                    'Kapasitas Baterai' => '6.144 Wh',
                    'Daya Output Inverter' => '6.500 W',
                    'Tegangan Output' => '230 VAC, 50/60 Hz (otomatis)',
                    'Daya Input AC Maks' => '9.000 W',
                    'Rentang Tegangan Input AC' => '170–280 VAC',
                    'Daya PV Maks' => '9.000 W',
                    'Rentang MPPT' => '60–450 VDC',
                    'Tegangan Input PV' => '60–500 VDC',
                    'Arus Pengisian' => '0–120 A',
                    'Efisiensi MPPT' => 'Hingga 99,5%',
                    'Pendinginan' => 'Kipas pintar (smart fan)',
                    'Suhu Operasi' => '-20°C s/d +50°C',
                    'Suhu Penyimpanan' => '-25°C s/d +55°C',
                    'Kelembapan' => '0–90% tanpa kondensasi',
                    'Dimensi (L×P×T)' => '460 × 205 × 740 mm (kemasan 555 × 300 × 800 mm)',
                    'Berat' => '53,5 kg (kemasan 56 kg)',
                    'Garansi' => '2 tahun',
                ]),
                'keywords' => 'all in one solar, jsd solar, xhp65k60, ess, 6.5kw, 6kwh, mppt 9000w, inverter baterai jadi satu, energy storage',
