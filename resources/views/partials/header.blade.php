...
<header class="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur" x-data="{ mega: false }">
    ...
    <div class="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
        ...
        <div class="hidden items-center gap-1 sm:gap-2 lg:flex">
            ...
            <a href="{{ route('cart.index') }}" @click.prevent="$store.cart.openDrawer()" class="relative rounded-lg p-2 text-gray-600 hover:bg-gray-100" aria-label="Keranjang">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"/></svg>
                <span x-cloak x-show="$store.cart.count > 0" x-text="$store.cart.count" class="absolute -right-0.5 -top-0.5 grid h-4 min-w-4 place-items-center rounded-full bg-accent-500 px-1 text-[10px] font-bold text-white"></span>
            </a>
